...
DROP TABLE ice_cream_shark_attack

create table ice_cream_shark_attack
as  
SELECT shark_attacks.attack_date, shark_attacks.attack_year, shark_attacks.attack_type, shark_attacks.attack_state, shark_attacks.attack_location, shark_attacks.activity, ice_cream.number_of_attacks, ice_cream.latitude, ice_cream.longitude, ice_cream.ice_cream, ice_cream.temperature
FROM shark_attacks
